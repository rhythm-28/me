...
function Contact(){
    ...
    return (
        <div>
            <Navbar />
            <ThirdNavbar />
            <h1 style={{color:'red',marginLeft:'2%',marginTop:'4%'}}>Help Centre</h1>
            <hr className="rule"/>
            <div className="row contact-us-div">
                <div className="col-6 contact-div">
                    <div className="form-div">
                        ...
                        <form>
                            <input onChange={(e)=>{setFName(e.target.value)}} className="contact-input-name" style={{marginRight:'4%'}} type="text" placeholder="First Name"></input>
                            <input onChange={(e)=>{setSName(e.target.value)}} className="contact-input-name" type="text" placeholder="Last Name"></input>
                            <input onChange={(e)=>{setEmail(e.target.value)}} className="contact-input" type="email" placeholder="E-mail Id"></input>
                            <input onChange={(e)=>{setReason(e.target.value)}} className="contact-input" type="text" placeholder="Reason"></input>
                            <textarea onChange={(e)=>{setAdditionalDetails(e.target.value)}} className="contact-input" type="text" placeholder="Additional Details" rows="5" cols="50"></textarea>
                        <br/>
                            <br />
                ...
                <div className="col-6">
                    ...
                    <div class="dropdown"style={{marginTop:'5%'}}>
                        <a style={{width:'80%'}} class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                            Order
                        </a>
